...
- A follow-up private-API inventory now ranks `qscriptengine_p.h` as the highest-leverage adaptation target and classifies representative failures into clear-equivalent, drifted-equivalent, obsolete, and deeper-bridge-study buckets.
