...
- Use the generated QtScript dependency inventory to define the minimum viable `CsScript` public/private API manifest before attempting declarative bring-up.
