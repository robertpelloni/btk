...
- Expand downstream BTK package validation beyond the now-working core/gui/network/opengl/svg/sql/multimedia/runtime smoke paths into richer GUI/package consumption examples.
