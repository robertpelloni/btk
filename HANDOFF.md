...
- Refined `BTKFocusOverlay` into a richer HUD pass with summary chips, structured sections, token summaries, and target-widget decision context.
...
3. Continue evolving `BTKFocusOverlay` from a lightweight HUD toward a richer multi-panel developer tool while refining mixed-owner popup behavior.
