...
- summary chips for popup owner, modal owner, refresh cadence, focus owner, focus surface, popup count, blocker count, blocked-route count, blocked-reason count, mismatch count, comparison-cluster count, and preset/mode state
...
- comparison-cluster section for focus/popup/modal owner topology
