...
- Refined `BTKFocusOverlay` into a richer HUD-style diagnostic surface.
...
- Continue evolving `BTKFocusOverlay` from a lightweight HUD toward a richer multi-panel developer tool while refining mixed-owner popup behavior.
